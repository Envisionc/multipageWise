...
const url_map = {
    ...
    allOrg_url: `${base_url}/api/mde-person/campus/app/organization/queryAllOrg`,
    queryRecords_url: `${base_url}/api/mde-person/campus/app/gateAttendanceRecord/queryRecords`,
    recordsDetail_url: `${base_url}/api/mde-person/campus/app/gateAttendanceRecord/queryRecordsDetail`,
}
